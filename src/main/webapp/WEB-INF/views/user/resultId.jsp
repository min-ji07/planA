  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
		...
		<section class="ftco-section ftco-services-2" id="services-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">아이디 찾기 완료</h2>
            <h4 class="mb-4">입력하신 정보와 일치하는 아이디입니다. <br> 비밀번호 분실 시에는 비밀번호 찾기를 진행해주세요.</h4>
            <h3 class="mb-4" style="color:#E2C0BB;">${userId }</h3><br>
            <input type="button" class="btn btn-primary" value="로그인 하기" style="width:20%; height:15%;" onclick="login();">&nbsp;&nbsp;&nbsp;
            <input type="button" class="btn btn-primary" value="비밀번호 찾기" style="width:20%; height:15%;" onclick="searchIdPwd();">
            <br>
          </div>
        </div>
			</div>
