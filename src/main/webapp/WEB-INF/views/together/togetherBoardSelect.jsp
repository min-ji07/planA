      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-4">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="tblist.me?page=1">동행구하기 <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog Single <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="tab-content py-5" id="v-pills-tabContent">
                                          ...
                                          <div class="col-lg align-self-end">
                                             ...
                                             <input type="button" onclick="myselect_board();" value="검색" class="form-control btn btn-primary">
                                                   <script type="text/javascript">
             											...
             											/* 이거지우지마 document.location.href="tbSelectMy.me?selected="+selected;  */
             											document.location.href="tbSelectMy.me?selected="+selected+'&page=${pi.currentPage}'; 
             													}	      
       										      </script>
                                            </div>
                                         </div>
     ...
     <table class="type10">
            ...
            <tr>   
                  ...
                  <th scope="cols" class="aventr" width="60">진행상태</th>
            </tr>
            </thead>
            <tr class="airplan">
 ...
 --%>
		...
		<tr align="center" height="20" id="buttonTab">
			<td colspan="6">
				...
				<c:if test="${ pi.currentPage > 1 }">
					<c:url var="before" value="tbSelectMy.me">
				...
				<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
					...
					<c:if test="${ p ne pi.currentPage }">
						<c:url var="pagination" value="tbSelectMy.me">
				...
				<c:if test="${ pi.currentPage < pi.maxPage }">
					<c:url var="after" value="tbSelectMy.me">
						<c:param name="page" value="${ pi.currentPage + 1 }"/>
					</c:url> 
					<a href="${ after }">[다음]</a>
