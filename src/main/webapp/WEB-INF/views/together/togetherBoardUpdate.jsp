      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-4">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="tblist.me?page=1">동행구하기 <i class="ion-ios-arrow-forward"></i></a></span> <span>게시판 수정하기 <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
                                ...
                                <div class="tab-pane fade show active" id="v-pills-guk" role="tabpanel" aria-labelledby="v-pills-guk-tab">
                                            <div class="container">
                                              ...
                                              <div class="col-md-12 heading-section text-center ftco-animate">
                                                          ...
                                                          <p>게시판을 수정해주세요</p>
																...
																<form action="tbUpdate.me" method="post" enctype="Multipart/form-data">
                                                                   <input type="hidden" name="tId" value="${TogetherBoard.tId }"/> 
                                                                     <div class="form-group">
                                                                      <label for="title">제목</label>
                                                                      <input type="text" class="form-control" id="title" name="title"  value="${TogetherBoard.title }">
                                                                    </div>
                       	      ...
                       	      <!--                                    <div class="form-group">
                                                                 ...
                                                                 <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="user_id" name="user_id" value="${TogetherBoard.user_id }" readonly>
                                                                  </div>
                                                                
                                                                    <div class="form-group">
                                                                      <label for="gender">작성자 성별</label> <br>
                                                                       <input type="text" name="gender" class="form-control" id="gender"  value="${TogetherBoard.gender }">
                                                                    ...
                                                                    <div class="form-group">
                                                                      ...
                                                                      <input type="text" class="form-control" id="age" name="age" value="${TogetherBoard.age }">
                                                                    </div>
                                                                    
                                                                    <div class="form-group">
                                                                      <label for="age">여행 날짜</label>
                                                                      <input type="text" class="form-control" id="travel_date" name="travel_date" value="${TogetherBoard.travel_date }">
                                                                    </div>

                                                                   <div class="form-group">
                                                                     <label for="content">내용</label>                                                                  
                                                                    <textarea name="content" id="content" cols="30" rows="10" class="form-control" >${TogetherBoard.content}</textarea>
                                                                  </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="gender2" class="form-control" id="gender2" value="${TogetherBoard.gender2 }">
                                     <!--                                    <input type="checkbox" name="gender2" value="남자">남자만 &nbsp;
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="age2" class="form-control" id="age2" value="${TogetherBoard.age2 }">
                                                                    </div>
                                                  
                                                  					<div class="form-group">
                                                                        <label for="ing">진행상태</label> <br>
                                                                        <input type="text" name="ing" class="form-control" id="ing" value="${TogetherBoard.ing }">
                                                                    </div>
                                                                  
                                                                    <div class="form-group">
                                                                        <label for="ing">작성날짜</label> <br>
                                                                        <input type="text" name="write_date" class="form-control" id="write_date" value="${TogetherBoard.write_date }">
                                                                    </div>
