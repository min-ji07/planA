    ...
    function html5Upload() {	
    	...
    	sUploadURL= '../../../../fileUpload.me'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '../../../../fileUpload.me',	//샘플 URL입니다.
 	        sCallback : '${contextPath}/resources/editor/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
